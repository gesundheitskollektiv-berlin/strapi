...
export interface ApiAlpraPageLandingAlpraPageLanding
  ...
  info: {
    displayName: '[ALPRA - PAGE] Landing';
    pluralName: 'alpra-page-landings';
    singularName: 'alpra-page-landing';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiAlpraPersonnelAlpraPersonnel
  extends Struct.CollectionTypeSchema {
  collectionName: 'alpra_personnels';
  info: {
    displayName: 'Alpra - Personal';
    pluralName: 'alpra-personnels';
    singularName: 'alpra-personnel';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiGekoAnnouncementGekoAnnouncement
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    when_text: Schema.Attribute.Text;
    where_address: Schema.Attribute.Text;
  };
}
...
export interface ApiGekoMaterialGekoMaterial
  extends Struct.CollectionTypeSchema {
  collectionName: 'geko_materials';
  info: {
    displayName: 'Geko - Materials';
    pluralName: 'geko-materials';
    singularName: 'geko-material';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::geko-material.geko-material'
    >;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiGekoMetaGekoMeta extends Struct.SingleTypeSchema {
  collectionName: 'geko_meta';
  info: {
    description: '';
    displayName: '[GEKO] Meta';
    pluralName: 'geko-metas';
    singularName: 'geko-meta';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiGekoPageDatenschutzerklaerungGekoPageDatenschutzerklaerung
  ...
  info: {
    description: '';
    displayName: '[GEKO - PAGE] Datenschutzerkl\u00E4rung';
    pluralName: 'geko-page-datenschutzerklaerungen';
    singularName: 'geko-page-datenschutzerklaerung';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiGekoPageImpressumGekoPageImpressum
  extends Struct.SingleTypeSchema {
  collectionName: 'geko_page_impressum';
  info: {
    description: '';
    displayName: '[GEKO - PAGE] Impressum';
    pluralName: 'geko-page-impressums';
    singularName: 'geko-page-impressum';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiGekoServiceGekoService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Relation<'oneToOne', 'api::geko-cta.geko-cta'>;
    description: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    external_link_only: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    inhouse: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
